...
// Cek permission - hanya super admin yang bisa akses halaman barang masuk ATK
if(!canRead('atk')){
    $_SESSION['error_message'] = "Anda tidak memiliki akses ke halaman Barang Masuk ATK!";
...
<html lang="en">
    <head>
        ...
        <title>Barang Masuk ATK - SELARAS</title>
...
.table tbody td { padding: 0.75rem 0.5rem; font-size: 0.875rem; color: var(--text-primary); vertical-align: middle; }
...
body.dark-mode .alert-info    { background: rgba(30, 41, 59, 0.8); color: #93c5fd; border-left-color: #3b82f6; }
body.dark-mode .alert-warning { background: rgba(30, 27, 23, 0.8); color: #fbbf24; border-left-color: #f59e0b; }
body.dark-mode .alert-danger  { background: rgba(30, 23, 23, 0.8); color: #fca5a5; border-left-color: #ef4444; }
body.dark-mode .alert-success { background: rgba(20, 30, 20, 0.8); color: #86efac; border-left-color: #10b981; }
...
body.dark-mode .form-control:disabled, body.dark-mode .form-control[readonly] { background: rgba(15, 23, 42, 0.6); color: #94a3b8; }
...
body.dark-mode .dataTables_wrapper .dataTables_length select { background: rgba(30, 41, 59, 0.8); border: 1px solid rgba(71, 85, 105, 0.5); color: #e2e8f0; }
body.dark-mode .periode-filter-box { background: rgba(59, 130, 246, 0.1); border-color: rgba(59, 130, 246, 0.3); }
body.dark-mode .periode-filter-box label { color: #93c5fd; }
    ...
    <body class="sb-nav-fixed">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <?php if(canRead('atk')): ?>
                            <a class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'masuk_atk.php' || basename($_SERVER['PHP_SELF']) == 'keluar_atk.php') ? '' : 'collapsed'; ?>" 
                               href="#" data-toggle="collapse" data-target="#collapseATK"
                               aria-expanded="<?php echo (basename($_SERVER['PHP_SELF']) == 'masuk_atk.php' || basename($_SERVER['PHP_SELF']) == 'keluar_atk.php') ? 'true' : 'false'; ?>"
                               aria-controls="collapseATK">
                                <div class="sb-nav-link-icon"><i class="bi bi-gear-fill"></i></div>
                                Pemrosesan ATK
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-chevron-down"></i></div>
                            </a>
                            <div class="collapse <?php echo (basename($_SERVER['PHP_SELF']) == 'masuk_atk.php' || basename($_SERVER['PHP_SELF']) == 'keluar_atk.php') ? 'show' : ''; ?>"
                                 id="collapseATK" aria-labelledby="headingATK" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'masuk_atk.php') ? 'active' : ''; ?>" href="masuk_atk.php">
                                        <div class="sb-nav-link-icon"><i class="bi bi-arrow-down-circle-fill"></i></div>
                                        Barang Masuk
                                    </a>
                                    <a class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'keluar_atk.php') ? 'active' : ''; ?>" href="keluar_atk.php">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1><i class="bi bi-arrow-down-circle"></i> Barang Masuk ATK</h1>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                        <?php
                                            $ambilsemuadatastock = mysqli_query($conn, "SELECT m.*, s.namabarang, s.satuan FROM masuk m, stok s WHERE s.idbarang = m.idbarang ORDER BY m.tanggal DESC");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delate<?=$idm;?>">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title"><i class="bi bi-pencil-square"></i> Edit Barang Masuk</h4>
                            ...
                            <form method="post">
                                <div class="modal-body">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-block" name="updatemasuk">
                ...
                <div class="modal fade" id="delate<?=$idm;?>">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title"><i class="bi bi-trash-fill"></i> Hapus Barang Masuk</h4>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                            <form method="post">
                                <div class="modal-body">
                                    ...
                                    <p style="color: var(--text-primary);">Apakah Anda yakin ingin menghapus data barang masuk berikut?</p>
                                    ...
                                    <input type="hidden" name="idm" value="<?=$idm;?>">
                                    <button type="submit" class="btn btn-danger btn-block" name="hapusmasuk">
        ...
        <div class="modal fade" id="myModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title"><i class="bi bi-plus-circle"></i> Tambah Barang Masuk</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <form method="post">
                        <div class="modal-body">
                            ...
                            <div class="periode-filter-box">
                                ...
                                <div class="filter-row">
                                    <select id="filter_bulan" class="form-control" onchange="filterBarangMasuk()">
                                    ...
                                    <select id="filter_tahun" class="form-control" onchange="filterBarangMasuk()">
                                        <?php
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text" id="barang-kosong-info" style="display:none; color: #ef4444;">
                                    ...
                                    Tidak ada barang pada periode ini.
                                </small>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Keterangan</label>
                                <input type="text" name="penerima" placeholder="Contoh: Supplier A / Pembelian" class="form-control" required>
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-primary btn-block" name="barangmasuk">
                                <i class="bi bi-check-circle"></i> Tambah Barang Masuk
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <!-- Data semua barang ATK dari PHP (JSON) -->
        <?php if(canCreate('atk')): ?>
        <script>
        var allBarangMasukData = <?php
        ...
        <!-- jQuery FULL (bukan slim) agar Bootstrap modal event berfungsi dengan benar -->
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                // Jalankan filter setelah modal selesai tampil
                ...
                $('#myModal').on('hidden.bs.modal', function() {
                    document.getElementById('barangnya').innerHTML = '<option value="">-- Pilih barang --</option>';
                    document.getElementById('badge-jumlah-barang').style.display = 'none';
                    document.getElementById('barang-kosong-info').style.display  = 'none';
                });
            });
            ...
            function filterBarangMasuk() {
                ...
                // Filter
                var filtered = allBarangMasukData.filter(function(b) {
                ...
                if (filtered.length === 0) {
                    ...
                    filtered.forEach(function(b) {
                        ...
                        opt.value       = b.id;
                        opt.textContent = b.nama + ' (' + b.satuan + ') — masuk: ' + b.tgl_label;
