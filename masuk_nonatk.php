...
// Cek permission - Hanya Super Admin dan Admin yang bisa akses halaman ini
// User tidak bisa akses halaman barang masuk Non-ATK
if (!canRead('non_atk')) {
...
<html lang="en">
    <head>
        ...
        <title>Barang Masuk Non-ATK - SELARAS</title>
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'masuk_nonatk.php' || basename($_SERVER['PHP_SELF']) == 'keluar_nonatk.php') ? '' : 'collapsed'; ?>"
                               href="#" data-toggle="collapse" data-target="#collapseNonATK"
                            ...
                            <div class="collapse <?php echo (basename($_SERVER['PHP_SELF']) == 'masuk_nonatk.php' || basename($_SERVER['PHP_SELF']) == 'keluar_nonatk.php') ? 'show' : ''; ?>"
                                 id="collapseNonATK" aria-labelledby="headingNonATK" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1><i class="bi bi-arrow-down-circle"></i> Barang Masuk Non-ATK</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <?php endif; ?>
                                <a href="exportmasuk_nonatk.php" class="btn btn-info">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                        <?php
                                            $ambilsemuadatastock = mysqli_query($conn, "SELECT m.*, s.namabarang, s.satuan FROM masuk_non_atk m, stok_non_atk s WHERE s.idbarang = m.idbarang ORDER BY m.tanggal DESC");
                        ...
                        <div class="modal-content">
                            ...
                            <form method="post">
                                <div class="modal-body">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-block" name="updatemasuk_nonatk">
                        ...
                        <div class="modal-content">
                            ...
                            <form method="post">
                                <div class="modal-body">
                                    ...
                                    <input type="hidden" name="idm" value="<?=$idm;?>">
                                    <button type="submit" class="btn btn-danger btn-block" name="hapusmasuk_nonatk">
                ...
                <div class="modal-content">
                    ...
                    <form method="post">
                        <div class="modal-body">
                            ...
                            <button type="submit" class="btn btn-primary btn-block" name="barangmasuk_nonatk">
