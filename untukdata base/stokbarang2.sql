...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Agu 2023 pada 16.13
...
(29, 46, '2023-08-18 10:12:38', 'iwan', 2, 3000000),
(31, 47, '2023-08-20 12:50:18', 'iwan', 4, 6000000);
...
(38, 47, '2023-08-20 13:15:22', 'Diamond Store', 5);
...
CREATE TABLE `stok` (
  `idbarang` int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `namabarang` varchar(50) NOT NULL,
  `deskripsi` varchar(50) NOT NULL,
  `stock` int(11) NOT NULL,
...
(47, 'Smartphone', 'Hp Pintar', 51, '83344476470b668bcd9d805a045a49fa.jpg', 1500000);
