...
// Cek permission - Hanya Super Admin yang bisa akses halaman ATK
if(!canRead('atk')){
    setNotification("Anda tidak memiliki akses ke halaman Barang Keluar ATK!", "danger");
...
<html lang="en">
    <head>
        ...
        <title>Barang Keluar ATK - SELARAS</title>
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1><i class="bi bi-arrow-up-circle"></i> Barang Keluar ATK</h1>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                        <?php
                                            $ambilsemuadatastock = mysqli_query($conn, "SELECT k.*, s.namabarang, s.satuan FROM keluar k, stok s WHERE s.idbarang = k.idbarang ORDER BY k.tanggal DESC");
                ...
                <div class="modal-content">
                    ...
                    <form method="post">
                        <div class="modal-body">
                            ...
                            <div class="periode-filter-box">
                                ...
                                <div class="filter-row">
                                    ...
                                    <select id="filter_tahun" class="form-control" onchange="filterBarang()">
                                        ...
                                        // Tampilkan 2 tahun ke depan s/d 4 tahun ke belakang
                            ...
                            <button type="submit" class="btn btn-primary btn-block" name="barangkeluar">
        ...
        var allBarangData = <?php
            ...
            while($row = mysqli_fetch_assoc($all_barang)){
                $stok = getStokAkhir($conn, $row['idbarang']);
                $barang_arr[] = [
                    'id'        => $row['idbarang'],
                    'nama'      => $row['namabarang'],
                    'satuan'    => $row['satuan'],
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="post"> 
                        <div class="modal-body">
                            <?php
                                $stok_tersedia  = getStokAkhir($conn, $idb);
                                $query_qty_lama = mysqli_query($conn, "SELECT qty FROM keluar WHERE idkeluar='$idk'");
                            ...
                            <button type="submit" class="btn btn-primary btn-block" name="updatekeluar">
                ...
                <div class="modal-content">
                    ...
                    <form method="post"> 
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="idb" value="<?=$idb;?>">
                            <input type="hidden" name="idk" value="<?=$idk;?>">
                            <button type="submit" class="btn btn-danger btn-block" name="hapuskeluar">
        ...
        <script>
            ...
            function filterBarang() {
                ...
                if (!select) return; // guard: element belum ada di DOM

                // Reset dropdown menggunakan loop (lebih reliable dari innerHTML)
